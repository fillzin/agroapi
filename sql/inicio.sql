...
update oauth_client_details set client_id = 'app', resource_ids = 'app', client_secret='$2a$10$mLRid4lCIcY6ZphoA4mlfumU6sXQfY9gE9FetVjGpcfBasNf4USiq' where client_id = 'app';
alter table user add column nome varchar(255);